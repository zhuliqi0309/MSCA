...
def main():
    ...
    parser.add_argument('--data_path', default="/home/shenxiang/sda/zhuliqi/MSCA/data/",
                        help='path to datasets')
    parser.add_argument('--data_name', default='f30k_precomp',
                        help='{coco,f30k}_precomp')
    parser.add_argument('--vocab_path', default="/home/shenxiang/sda/zhuliqi/MSCA/data/vocab/",
    ...
    parser.add_argument('--thres_safe', default=0, type=float,
                        help='Optimal learning  boundary.')
    parser.add_argument('--mean_neg1', default=0, type=float,
                        help='Mean value of mismatched distribution.')
    parser.add_argument('--stnd_neg1', default=0, type=float,
                        help='Standard deviation of mismatched distribution.')
    parser.add_argument('--mean_pos1', default=0, type=float,
                        help='Mean value of matched distribution.')
    parser.add_argument('--stnd_pos1', default=0, type=float,
                        help='Standard deviation of matched distribution.')
...
def validate(opt, val_loader, model, epoch):
    ...
    start = time.time()
    sims = shard_xattn(img_embs, cap_embs, cap_lens, opt, shard_size=100)
    end = time.time()
